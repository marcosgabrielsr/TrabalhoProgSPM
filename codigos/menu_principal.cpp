...
void menu_principal(pessoa *&pessoas, viatura *&viaturas, policia *&policiais, chamada *chamadas, chamada *&p_begin, chamada *&p_end, chamada *&np_begin, chamada *&np_end){
    int op;
